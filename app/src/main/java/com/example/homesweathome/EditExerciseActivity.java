...
public class EditExerciseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timeLayout = findViewById(R.id.new_timeLayout);
        repLayout = findViewById(R.id.new_repLayout);
        databaseWorkouts = FirebaseDatabase.getInstance().getReference("Exercises");
        setChoice = findViewById(R.id.new_sets);
        setChoice.setMinValue(0);
        setChoice.setMaxValue(10);
        repChoice = findViewById(R.id.new_repetitions);
        repChoice.setMinValue(0);
        repChoice.setMaxValue(50);
        minChoice = findViewById(R.id.new_minutes);
        minChoice.setMinValue(0);
        minChoice.setMaxValue(60);
        secChoice = findViewById(R.id.new_seconds);
        secChoice.setMinValue(0);
        secChoice.setMaxValue(59);


        editTextExcerciseName = findViewById(R.id.new_editTextExcerciseName);
        buttonAddWorkoutreps = findViewById(R.id.new_buttonAddWorkoutReps);
        buttonAddWorkouttime = findViewById(R.id.new_buttonAddWorkouttime);
